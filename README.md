...
A small, self-contained library for generating PDF files from Delphi 12+ code.
No third-party dependencies; the library writes PDF 1.4 bytes directly.
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p><b>Standalone invoice</b> — text alignment, paragraphs, table headers, ovals as a logo, and custom RGB throughout. ~6 KB output, Standard 14 fonts only. Source: <a href="Demos/Invoice/"><code>Demos/Invoice/</code></a>.</p>
    </td>
    <td width="50%" valign="top">
